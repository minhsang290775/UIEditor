...
function getToolBarNameByType(winType)
	if winType == "Falagard/MultiColumnList" then
		return "多行列表框";
	elseif winType == "Falagard/SoftKeyWindow" then
		return "软键盘窗口";
	elseif winType == "Falagard/Slider" then
		return "Slider窗口";
	elseif winType == "Falagard/PaoPao" then
		return "冒泡窗口";
	elseif winType == "Falagard/SelfFitWindow" then
		return "自适应文本窗口";
	elseif winType == "Falagard/AnimateWindow" then
		return "动画窗口1";
	elseif winType == "Falagard/Animate" then
		return "动画窗口2";
	elseif winType == "Falagard/StopWatch" then
		return "倒计时窗口";
	elseif winType == "Falagard/CreatureBoard" then
		return "头顶信息板";
	elseif winType == "Falagard/Minimap" then
		return "MiniMap窗口";
	elseif winType == "Falagard/InfoList" then
		return "InfoList窗口";
	elseif winType == "Falagard/WorldMap" then
		return "世界地图窗口";
	elseif winType == "Falagard/SceneMap" then
		return "场景地图窗口";
	elseif winType == "Falagard/SuperProgress" then
		return "超级进度条窗口";
	elseif winType == "Falagard/MeshWindow" then
		return "界面显示Avtar窗口";
	elseif winType == "Falagard/SimpleText" then
		return "普通文本窗口";
	elseif winType == "Falagard/Money" then
		return "金钱控件窗口";
	elseif winType == "Falagard/Button_Combo" then
		return "Combo 窗口";
	elseif winType == "Falagard/ComboEditbox" then
		return "Combo 窗口(可编辑)";
	elseif winType == "Falagard/ComboList" then
		return "Combo 窗口(带列表)";
	elseif winType == "Falagard/ComboDropList" then
		return "Combo 窗口(带列表)";
	elseif winType == "Falagard/Listbox_Debug" then
		return "列表提示条窗口";
	elseif winType == "Falagard/Listbox" then
		return "普通列表框窗口";
	elseif winType == "Falagard/SuperTooltip" then
		return "超级Tooltip";
	elseif winType == "Falagard/Tooltip" then
		return "普通Tooltip";
	elseif winType == "Falagard/PopupMenu" then
		return "弹出菜单窗口";
	elseif winType == "Falagard/MenuItem" then
		return "菜单项窗口";
	elseif winType == "Falagard/SystemButton" then
		return "系统按钮窗口";
	elseif winType == "Falagard/Titlebar_2" then
		return "标题窗口2";
	elseif winType == "Falagard/Titlebar" then
		return "标题窗口1";
	elseif winType == "Falagard/FrameWindow_HelpText" then
		return "框架窗口带帮助";
	elseif winType == "Falagard/Button_MiniClose" then
		return "MiniClose按钮";
	elseif winType == "Falagard/HorizontalScrollbar" then
		return "水平滚动条";
	elseif winType == "Falagard/VerticalScrollbar" then
		return "垂直滚动条";
	elseif winType == "Falagard/StaticImage" then
		return "静态图像窗口";
	elseif winType == "Falagard/StaticText3" then
		return "静态文本3";
	elseif winType == "Falagard/StaticText2" then
		return "静态文本2";
	elseif winType == "Falagard/StaticText" then
		return "静态文本1";
	elseif winType == "Falagard/MultiIMEEditBox" then
		return "多行输入框";
	elseif winType == "Falagard/ChatEditbox_IME" then
		return "聊天输入窗口";
	elseif winType == "Falagard/IMEEditBox" then
		return "支持中文的单行输入框";
	elseif winType == "Falagard/Editbox_1" then
		return "普通输入框1";
	elseif winType == "Falagard/Editbox_2" then
		return "普通输入框2";
	elseif winType == "Falagard/Editbox_3" then
		return "普通输入框3";
	elseif winType == "Falagard/Editbox_4" then
		return "普通输入框4";
	elseif winType == "Falagard/Editbox_5" then
		return "普通输入框5";
	elseif winType == "Falagard/Editbox_6" then
		return "普通输入框6";
	elseif winType == "Falagard/ActionButton" then
		return "ActionButton窗口";
	elseif winType == "Falagard/Button_Text" then
		return "带文本的Button窗口";
	elseif winType == "Falagard/Button_1" then
		return "按钮1";
	elseif winType == "Falagard/Button_2" then
		return "按钮2";
	elseif winType == "Falagard/Button_3" then
		return "按钮3";
	elseif winType == "Falagard/Button_4" then
		return "按钮4";
	elseif winType == "Falagard/Button_5" then
		return "按钮5";
	elseif winType == "Falagard/Button_6" then
		return "按钮6";
	elseif winType == "Falagard/Button_7" then
		return "按钮7";
	elseif winType == "Falagard/Button_8" then
		return "按钮8";
	elseif winType == "Falagard/ButtonDrop" then
		return "Drop按钮";
	elseif winType == "Falagard/ButtonSale" then
		return "Sale按钮";
	elseif winType == "Falagard/FrameWindow" then
		return "框架窗口";
	end
	return "";
end
